...
echo "Successful Queries:"
test_2_4_1=$(curl -X PATCH "http://localhost:8000/courses/3" -H "accept: */*" -H "Authorization: Bearer ${bearerToken}" -H "Content-Type: application/json" -d "{\"courseId\":\"15\",\"subject\":\"mth\",\"number\":\"432\",\"title\":\"something new\",\"instructorId\":\"3\"}")
...
echo "Successful Queries:"
test_2_7_1=$(curl -X POST "http://localhost:8000/courses/7/students" -H "accept: */*" -H "Content-Type: application/json" -H "Authorization: Bearer ${bearerToken}" -d "{\"id\":\"1\",\"add\":[\"4\",\"5\",\"6\"],\"remove\":[\"7\"]}")
...
echo " "
echo "Failed Queries:"
test_2_7_3=$(curl -X POST "http://localhost:8000/courses/2/students" -H "accept: */*" -H "Content-Type: application/json" -H "Authorization: Bearer ${bearerToken}" -d "{\"id\":\"3\",\"add\":[\"6\",\"7\",\"8\"],\"remove\":[\"5\"]}")
